...
//  smack
//
//  Created by Ziad Ahmed Said Ahmed on 6/16/20.
...
class gradientView: UIView {
    ...
    @IBInspectable var buttomColor: UIColor = #colorLiteral(red: 0.2901960784, green: 0.3019607843, blue: 0.8470588235, alpha: 1) {
        didSet {
            self.setNeedsLayout()
        }
    }
